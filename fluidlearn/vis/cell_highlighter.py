...
class GridCellHighlighter2D:
    _highlighting = False
    _highlighted_cell = np.array([-1, -1], dtype=int)
    ...
    def __init__(self, controller, plotter, data, image_object):
        self._controller = controller
        self._plotter = plotter
        self._data = data

        image_object.add_event_handler(self.on_pointer_move, "pointer_move")
        image_object.add_event_handler(self.on_pointer_leave, "pointer_leave")
